...
=head1 Curating and improving Perl6 documentation
...
=item Refactor documentation tests and write new ones to make new additions follow guidelines. This is already in an issue in the GitHub repo.
...
=head3 Country of Residence and nationality

Spain and Spanish. 

=head2 Suggestions for Grant Manager
